...
from ltlf2dfa.base import AtomicFormula, UnaryOperator
...
def return_subformulae(s):
    ...
    try:
        ...
        while(not q.empty()):
            ...
            subformulae.insert(0,result)
            #print(result)
            #print("------------")
            if(not isinstance(result, AtomicFormula)):
                t = result._members()[1]
            else:
                continue

            if isinstance(t, Iterable):
                #if operation was binary
                for c in t:
                    q.put(c)
            else:
                #if operation was unary
                q.put(t)
...
if __name__ == "__main__":
    ...
    while True:
        ...
        '''
        This program shows all subformulas of given LTL formula.
        Most of code is from python project ltlf2dfa
        '''
